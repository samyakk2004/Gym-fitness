        ...
        <>
            ...
            <div className="about-container">
                ...
                <p>
                    ...
                    CSS, JS, NodeJS, ExpressJS and MongoDB. I'm currently looking for jobs and internships to
                    start off my engineering career. Hope you find this project up to the mark. Feel free to contact me 
                    at 8617382715 for any oppurtunities. I would be more than obliged if you do so. Thank you have a nice day!
                </p>
                <h1>About the API</h1>
                <p>
